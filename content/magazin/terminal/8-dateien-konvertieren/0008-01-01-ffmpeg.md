...
Deine Dateien von z.B. *m4a* zu *wav* oder *mp4* zu *mpg*. Bekannte
Programme, die FFmpeg verwenden, sind unter anderem VLC, xine oder
HandBrake. Im Folgenden findest Du ein paar ffmpeg-Formeln für die
Decodierung, Encodierung, Konvertierung von Audio- und Videodateien.
...
![bigbuckbunny](../images/bigbuckbunny.gif)
